...
class CrawlsiteSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $canadianNewsWebsites = [
            ['title' => 'CP24', 'url' => 'https://www.cp24.com/news', 'searchTerms' => 'prescription,gang,drug,SMOKE JOINT,GROW OP,CANNABI,IMPAIR,SHOOT,FIREARM,MURDER,COCAIN,POSSESS,BREAK ENTER'],
