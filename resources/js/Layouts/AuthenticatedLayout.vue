...
<template>
    <div>
        <div class="min-h-screen bg-[#171923]">
            <nav class="bg-[#171923] border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <div class="text-gray-300 hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            ...
            <!-- Page Heading -->
            <header class="bg-[#171923] shadow text-gray-300" v-if="$slots.header">
